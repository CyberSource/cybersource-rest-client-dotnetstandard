...
namespace CyberSource.Api
{
    ...
    public interface IDecisionManagerApi : IApiAccessor
    {
        ...
        ApiResponse<InlineResponse200> ActionDecisionManagerCaseWithHttpInfo (string id, CaseManagementActionsRequest caseManagementActionsRequest);
        /// <summary>
        /// List Management
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<InlineResponse200> ActionDecisionManagerCaseAsync (string id, CaseManagementActionsRequest caseManagementActionsRequest);
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse200>> ActionDecisionManagerCaseAsyncWithHttpInfo (string id, CaseManagementActionsRequest caseManagementActionsRequest);
        /// <summary>
        /// List Management
        /// </summary>
        /// <remarks>
    ...
    public partial class DecisionManagerApi : IDecisionManagerApi
    {
        ...
        /// <param name="caseManagementActionsRequest"></param>
        /// <returns>InlineResponse200</returns>
        public InlineResponse200 ActionDecisionManagerCase (string id, CaseManagementActionsRequest caseManagementActionsRequest)
        {
            logger.Debug("CALLING API \"ActionDecisionManagerCase\" STARTED");
            this.SetStatusCode(null);
            ApiResponse<InlineResponse200> localVarResponse = ActionDecisionManagerCaseWithHttpInfo(id, caseManagementActionsRequest);
        ...
        /// <param name="caseManagementActionsRequest"></param>
        /// <returns>ApiResponse of InlineResponse200</returns>
        public ApiResponse< InlineResponse200 > ActionDecisionManagerCaseWithHttpInfo (string id, CaseManagementActionsRequest caseManagementActionsRequest)
        {
            ...
            if (MLEUtility.CheckIsMLEForAPI(merchantConfig, isMLESupportedByCybsForApi, "ActionDecisionManagerCase,ActionDecisionManagerCaseAsync,ActionDecisionManagerCaseWithHttpInfo,ActionDecisionManagerCaseAsyncWithHttpInfo"))
            {
                try
                {
        ...
        /// <param name="caseManagementActionsRequest"></param>
        /// <returns>Task of InlineResponse200</returns>
        public async System.Threading.Tasks.Task<InlineResponse200> ActionDecisionManagerCaseAsync (string id, CaseManagementActionsRequest caseManagementActionsRequest)
        {
            logger.Debug("CALLING API \"ActionDecisionManagerCaseAsync\" STARTED");
            this.SetStatusCode(null);
            ApiResponse<InlineResponse200> localVarResponse = await ActionDecisionManagerCaseAsyncWithHttpInfo(id, caseManagementActionsRequest);
        ...
        /// <param name="caseManagementActionsRequest"></param>
        /// <returns>Task of ApiResponse (InlineResponse200)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse200>> ActionDecisionManagerCaseAsyncWithHttpInfo (string id, CaseManagementActionsRequest caseManagementActionsRequest)
        {
            LogUtility logUtility = new LogUtility();
        ...
        public ApiResponse< RiskV1UpdatePost201Response > AddNegativeWithHttpInfo (string type, AddNegativeListRequest addNegativeListRequest)
        {
            ...
            bool isMLESupportedByCybsForApi = false;
            MerchantConfig merchantConfig = new MerchantConfig(Configuration.MerchantConfigDictionaryObj, Configuration.MapToControlMLEonAPI);
            if (MLEUtility.CheckIsMLEForAPI(merchantConfig, isMLESupportedByCybsForApi, "AddNegative,AddNegativeAsync,AddNegativeWithHttpInfo,AddNegativeAsyncWithHttpInfo"))
            {
                try
                {
                    localVarPostBody = MLEUtility.EncryptRequestPayload(merchantConfig, localVarPostBody);
        ...
        public ApiResponse< InlineResponse201 > CommentDecisionManagerCaseWithHttpInfo (string id, CaseManagementCommentsRequest caseManagementCommentsRequest)
        {
            ...
            bool isMLESupportedByCybsForApi = false;
            MerchantConfig merchantConfig = new MerchantConfig(Configuration.MerchantConfigDictionaryObj, Configuration.MapToControlMLEonAPI);
            if (MLEUtility.CheckIsMLEForAPI(merchantConfig, isMLESupportedByCybsForApi, "CommentDecisionManagerCase,CommentDecisionManagerCaseAsync,CommentDecisionManagerCaseWithHttpInfo,CommentDecisionManagerCaseAsyncWithHttpInfo"))
            {
                try
                {
                    localVarPostBody = MLEUtility.EncryptRequestPayload(merchantConfig, localVarPostBody);
        ...
        public ApiResponse< RiskV1DecisionsPost201Response > CreateBundledDecisionManagerCaseWithHttpInfo (CreateBundledDecisionManagerCaseRequest createBundledDecisionManagerCaseRequest)
        {
            ...
            bool isMLESupportedByCybsForApi = false;
            MerchantConfig merchantConfig = new MerchantConfig(Configuration.MerchantConfigDictionaryObj, Configuration.MapToControlMLEonAPI);
            if (MLEUtility.CheckIsMLEForAPI(merchantConfig, isMLESupportedByCybsForApi, "CreateBundledDecisionManagerCase,CreateBundledDecisionManagerCaseAsync,CreateBundledDecisionManagerCaseWithHttpInfo,CreateBundledDecisionManagerCaseAsyncWithHttpInfo"))
            {
                try
                {
                    localVarPostBody = MLEUtility.EncryptRequestPayload(merchantConfig, localVarPostBody);
        ...
        public ApiResponse< RiskV1UpdatePost201Response > FraudUpdateWithHttpInfo (string id, FraudMarkingActionRequest fraudMarkingActionRequest)
        {
            ...
            bool isMLESupportedByCybsForApi = false;
            MerchantConfig merchantConfig = new MerchantConfig(Configuration.MerchantConfigDictionaryObj, Configuration.MapToControlMLEonAPI);
            if (MLEUtility.CheckIsMLEForAPI(merchantConfig, isMLESupportedByCybsForApi, "FraudUpdate,FraudUpdateAsync,FraudUpdateWithHttpInfo,FraudUpdateAsyncWithHttpInfo"))
            {
                try
                {
                    localVarPostBody = MLEUtility.EncryptRequestPayload(merchantConfig, localVarPostBody);
