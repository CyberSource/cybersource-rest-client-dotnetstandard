...
REM powershell Rename-Item ..\src\Cybersource.Test\Model\PtsV2PaymentsPost201ResponseConsumerAuthenticationInformationStrongAuthenticationIssuerInformation.cs PtsV2PaymentsPost201IssuerInformation.cs
