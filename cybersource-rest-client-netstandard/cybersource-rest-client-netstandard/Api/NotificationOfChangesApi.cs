...
namespace CyberSource.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class NotificationOfChangesApi : ApiBase, INotificationOfChangesApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationOfChangesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public NotificationOfChangesApi(string basePath) : base(basePath)
        {
        }
        ...
        /// <returns></returns>
        public NotificationOfChangesApi(IConfiguration configuration = null) : base(configuration)
        {
        }
        ...
        public ApiResponse< ReportingV3NotificationofChangesGet200Response > GetNotificationOfChangeReportWithHttpInfo(DateTime? startTime, DateTime? endTime)
        {
            ...
            if (MLEUtility.CheckIsMLEForAPI(Configuration.MerchantMLESettings, inboundMLEStatus, "GetNotificationOfChangeReport,GetNotificationOfChangeReportAsync,GetNotificationOfChangeReportWithHttpInfo,GetNotificationOfChangeReportAsyncWithHttpInfo"))
            {
                try
                {
            ...
            bool isResponseMLEForApi = MLEUtility.CheckIsResponseMLEForAPI(Configuration.MerchantMLESettings, "GetNotificationOfChangeReport,GetNotificationOfChangeReportAsync,GetNotificationOfChangeReportWithHttpInfo,GetNotificationOfChangeReportAsyncWithHttpInfo");
        ...
        /// <param name="endTime">Valid report End Time in **ISO 8601 format** Please refer the following link to know more about ISO 8601 format.[Rfc Date Format](https://xml2rfc.tools.ietf.org/public/rfc/html/rfc3339.html#anchor14)  **Example date format:**   - yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ (e.g. 2018-01-01T00:00:00.000Z) </param>
        /// <returns>Task of ApiResponse (ReportingV3NotificationofChangesGet200Response)</returns>
        public async Task<ApiResponse<ReportingV3NotificationofChangesGet200Response>> GetNotificationOfChangeReportAsyncWithHttpInfo(DateTime? startTime, DateTime? endTime)
        {
            LogUtility logUtility = new LogUtility();
