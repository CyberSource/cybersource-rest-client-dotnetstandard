...
namespace CyberSource.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class OffersApi : ApiBase, IOffersApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OffersApi"/> class.
        /// </summary>
        /// <returns></returns>
        public OffersApi(string basePath) : base(basePath)
        {
        }
        ...
        /// <returns></returns>
        public OffersApi(IConfiguration configuration = null) : base(configuration)
        {
        }
        ...
        public ApiResponse< InlineResponse2019 > CreateOfferWithHttpInfo(string contentType, string xRequestid, string vCMerchantId, string vCCorrelationId, string vCOrganizationId, OfferRequest offerRequest)
        {
            ...
            if (offerRequest != null && offerRequest.GetType() != typeof(byte[]))
            {
                ...
                offerRequest = (OfferRequest)sdkTracker.InsertDeveloperIdTracker(offerRequest, offerRequest.GetType().Name, Configuration.MerchantCredentialSettings.RunEnvironment, Configuration.MerchantNetworkSettings.DefaultDeveloperId);
                localVarPostBody = ApiClient.Serialize(offerRequest); // http body (model) parameter
            }
            else
            {
            ...
            if (MLEUtility.CheckIsMLEForAPI(Configuration.MerchantMLESettings, inboundMLEStatus, "CreateOffer,CreateOfferAsync,CreateOfferWithHttpInfo,CreateOfferAsyncWithHttpInfo"))
            {
                try
                {
        ...
        public ApiResponse< InlineResponse20016 > GetOfferWithHttpInfo(string contentType, string xRequestid, string vCMerchantId, string vCCorrelationId, string vCOrganizationId, string id)
        {
            ...
            string inboundMLEStatus = "false";
            if (MLEUtility.CheckIsMLEForAPI(Configuration.MerchantMLESettings, inboundMLEStatus, "GetOffer,GetOfferAsync,GetOfferWithHttpInfo,GetOfferAsyncWithHttpInfo"))
            {
                try
                {
                    localVarPostBody = MLEUtility.EncryptRequestPayload(Configuration.MerchantCredentialSettings, Configuration.MerchantMLESettings, localVarPostBody);
            ...
            bool isResponseMLEForApi = MLEUtility.CheckIsResponseMLEForAPI(Configuration.MerchantMLESettings, "GetOffer,GetOfferAsync,GetOfferWithHttpInfo,GetOfferAsyncWithHttpInfo");
        ...
        /// <param name="id">Request ID generated by Cybersource. This was sent in the header on the request. Echo value from v-c-request-id</param>
        /// <returns>Task of ApiResponse (InlineResponse20016)</returns>
        public async Task<ApiResponse<InlineResponse20016>> GetOfferAsyncWithHttpInfo(string contentType, string xRequestid, string vCMerchantId, string vCCorrelationId, string vCOrganizationId, string id)
        {
            LogUtility logUtility = new LogUtility();
