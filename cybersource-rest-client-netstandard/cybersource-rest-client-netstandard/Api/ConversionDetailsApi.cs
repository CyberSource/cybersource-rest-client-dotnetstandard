...
namespace CyberSource.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ConversionDetailsApi : ApiBase, IConversionDetailsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversionDetailsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ConversionDetailsApi(string basePath) : base(basePath)
        {
        }
        ...
        /// <returns></returns>
        public ConversionDetailsApi(IConfiguration configuration = null) : base(configuration)
        {
        }
        ...
        public ApiResponse< ReportingV3ConversionDetailsGet200Response > GetConversionDetailWithHttpInfo(DateTime? startTime, DateTime? endTime, string organizationId = null)
        {
            ...
            if (startTime == null)
            {
                logger.Error("ApiException : Missing required parameter 'startTime' when calling ConversionDetailsApi->GetConversionDetail");
            ...
            if (endTime == null)
            {
                logger.Error("ApiException : Missing required parameter 'endTime' when calling ConversionDetailsApi->GetConversionDetail");
            ...
            if (MLEUtility.CheckIsMLEForAPI(Configuration.MerchantMLESettings, inboundMLEStatus, "GetConversionDetail,GetConversionDetailAsync,GetConversionDetailWithHttpInfo,GetConversionDetailAsyncWithHttpInfo"))
            {
                try
                {
            ...
            bool isResponseMLEForApi = MLEUtility.CheckIsResponseMLEForAPI(Configuration.MerchantMLESettings, "GetConversionDetail,GetConversionDetailAsync,GetConversionDetailWithHttpInfo,GetConversionDetailAsyncWithHttpInfo");
            ...
            return new ApiResponse<ReportingV3ConversionDetailsGet200Response>(localVarStatusCode,
                ...
                (ReportingV3ConversionDetailsGet200Response) ApiClient.Deserialize(localVarResponse, typeof(ReportingV3ConversionDetailsGet200Response))); // Return statement
        }
