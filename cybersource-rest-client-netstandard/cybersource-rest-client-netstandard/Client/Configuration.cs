...
namespace CyberSource.Client
{
    ...
    public class Configuration
    {
        ...
        public static readonly ExceptionFactory DefaultExceptionFactory = (methodName, response) =>
        {
            ...
            if (status >= 400) return new ApiException(status, String.Format("Error calling {0}: {1}", methodName, response.Content), response.Content, response, innerException: errorException);
            if (status == 0) return new ApiException(status, String.Format("Error calling {0}: {1}", methodName, response.ErrorMessage), response.ErrorMessage, response, innerException: errorException);
            return null;
        };
        ...
        /// <summary>
        /// Gets or sets the default HTTP headers to be sent with every request.
        /// </summary>
        /// <value>Dictionary of HTTP header</value>
        [Obsolete("This property is deprecated and will be removed in the next major release")]
        ...
        /// <returns></returns>
        [Obsolete("This method is depreacted and will be removed in the next major release")]
