...
namespace CyberSource.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class RetrievalDetailsApi : ApiBase, IRetrievalDetailsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrievalDetailsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public RetrievalDetailsApi(string basePath) : base(basePath)
        {
        }
        ...
        /// <returns></returns>
        public RetrievalDetailsApi(IConfiguration configuration = null) : base(configuration)
        {
        }
        ...
        public ApiResponse< ReportingV3RetrievalDetailsGet200Response > GetRetrievalDetailsWithHttpInfo(DateTime? startTime, DateTime? endTime, string organizationId = null)
        {
            ...
            if (MLEUtility.CheckIsMLEForAPI(Configuration.MerchantMLESettings, inboundMLEStatus, "GetRetrievalDetails,GetRetrievalDetailsAsync,GetRetrievalDetailsWithHttpInfo,GetRetrievalDetailsAsyncWithHttpInfo"))
            {
                try
                {
            ...
            bool isResponseMLEForApi = MLEUtility.CheckIsResponseMLEForAPI(Configuration.MerchantMLESettings, "GetRetrievalDetails,GetRetrievalDetailsAsync,GetRetrievalDetailsWithHttpInfo,GetRetrievalDetailsAsyncWithHttpInfo");
            ...
            return new ApiResponse<ReportingV3RetrievalDetailsGet200Response>(localVarStatusCode,
                ...
                (ReportingV3RetrievalDetailsGet200Response) ApiClient.Deserialize(localVarResponse, typeof(ReportingV3RetrievalDetailsGet200Response))); // Return statement
        }
        ...
        /// <param name="organizationId">Valid Organization Id (optional)</param>
        /// <returns>Task of ReportingV3RetrievalDetailsGet200Response</returns>
        public async Task<ReportingV3RetrievalDetailsGet200Response> GetRetrievalDetailsAsync(DateTime? startTime, DateTime? endTime, string organizationId = null)
        {
        ...
        /// <param name="organizationId">Valid Organization Id (optional)</param>
        /// <returns>Task of ApiResponse (ReportingV3RetrievalDetailsGet200Response)</returns>
        public async Task<ApiResponse<ReportingV3RetrievalDetailsGet200Response>> GetRetrievalDetailsAsyncWithHttpInfo(DateTime? startTime, DateTime? endTime, string organizationId = null)
        {
            LogUtility logUtility = new LogUtility();
