...
//        ApiResponse<InlineResponse20014> GetOfferWithHttpInfo (string contentType, string xRequestid, string vCMerchantId, string vCCorrelationId, string vCOrganizationId, string id);
...
//        System.Threading.Tasks.Task<InlineResponse20014> GetOfferAsync (string contentType, string xRequestid, string vCMerchantId, string vCCorrelationId, string vCOrganizationId, string id);
...
//        System.Threading.Tasks.Task<ApiResponse<InlineResponse20014>> GetOfferAsyncWithHttpInfo (string contentType, string xRequestid, string vCMerchantId, string vCCorrelationId, string vCOrganizationId, string id);
...
//                (InlineResponse2018) Configuration.ApiClient.Deserialize(localVarResponse, typeof(InlineResponse2018))); // Return statement
//        }
...
//            this.SetStatusCode(null);
//            ApiResponse<InlineResponse20014> localVarResponse = GetOfferWithHttpInfo(contentType, xRequestid, vCMerchantId, vCCorrelationId, vCOrganizationId, id);
...
//        /// <param name="id">Request ID generated by Cybersource. This was sent in the header on the request. Echo value from v-c-request-id</param>
//        /// <returns>Task of InlineResponse20014</returns>
//        public async System.Threading.Tasks.Task<InlineResponse20014> GetOfferAsync (string contentType, string xRequestid, string vCMerchantId, string vCCorrelationId, string vCOrganizationId, string id)
//        {
//            logger.Debug("CALLING API \"GetOfferAsync\" STARTED");
//            this.SetStatusCode(null);
//            ApiResponse<InlineResponse20014> localVarResponse = await GetOfferAsyncWithHttpInfo(contentType, xRequestid, vCMerchantId, vCCorrelationId, vCOrganizationId, id);
...
//        /// <param name="id">Request ID generated by Cybersource. This was sent in the header on the request. Echo value from v-c-request-id</param>
//        /// <returns>Task of ApiResponse (InlineResponse20014)</returns>
//        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse20014>> GetOfferAsyncWithHttpInfo (string contentType, string xRequestid, string vCMerchantId, string vCCorrelationId, string vCOrganizationId, string id)
//        {
//            LogUtility logUtility = new LogUtility();
