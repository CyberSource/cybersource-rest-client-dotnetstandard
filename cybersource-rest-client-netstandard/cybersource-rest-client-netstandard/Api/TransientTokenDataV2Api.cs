...
namespace CyberSource.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class TransientTokenDataV2Api : ITransientTokenDataV2Api
    {
        ...
        /// </summary>
        /// <returns></returns>
        public TransientTokenDataV2Api(string basePath)
        {
        ...
        /// <returns></returns>
        public TransientTokenDataV2Api(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> GetTransactionForTransientTokenJTIWithHttpInfo (string jti)
        {
			...
			string inboundMLEStatus = "false";            
			MerchantConfig merchantConfig = new MerchantConfig(Configuration.MerchantConfigDictionaryObj, Configuration.MapToControlMLEonAPI, Configuration.ResponseMlePrivateKey);
            if (MLEUtility.CheckIsMLEForAPI(merchantConfig, inboundMLEStatus, "GetTransactionForTransientTokenJTI,GetTransactionForTransientTokenJTIAsync,GetTransactionForTransientTokenJTIWithHttpInfo,GetTransactionForTransientTokenJTIAsyncWithHttpInfo"))
            {
                try
                {
                    localVarPostBody = MLEUtility.EncryptRequestPayload(merchantConfig, localVarPostBody);
            ...
            bool isResponseMLEForApi = MLEUtility.CheckIsResponseMLEForAPI(merchantConfig, "GetTransactionForTransientTokenJTI,GetTransactionForTransientTokenJTIAsync,GetTransactionForTransientTokenJTIWithHttpInfo,GetTransactionForTransientTokenJTIAsyncWithHttpInfo");
        ...
        /// <param name="jti">The jti within the Transient Token jwt returned by the Unified Checkout application </param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task GetTransactionForTransientTokenJTIAsync (string jti)
        {
        ...
        /// <param name="jti">The jti within the Transient Token jwt returned by the Unified Checkout application </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> GetTransactionForTransientTokenJTIAsyncWithHttpInfo (string jti)
        {
            LogUtility logUtility = new LogUtility();
